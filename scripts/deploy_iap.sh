...
GCP_ORGANIZATION_ID="${GCP_ORGANIZATION_ID:-256890650197}"
...
env_vars="AUTH_MODE=iap,GOOGLE_CLOUD_PROJECT=${PROJECT_ID},GOOGLE_CLOUD_PROJECT_NUMBER=${PROJECT_NUMBER},IAP_ALLOWED_DOMAIN=${IAP_ALLOWED_DOMAIN},GCP_ORGANIZATION_ID=${GCP_ORGANIZATION_ID},DEV_AUTH_BYPASS=false"
